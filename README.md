...
| • In the quest to understand (__), what is the upper limit of (_) & what is its lower limit? Bandwidth can be used here, not neccessrily in the context of electronics, but it can be abstract. |
